      ...
      <div className={style.topdiv} id="top">
        <div className={style.nameDiv}>
          ...
          <p className={style.description}>
            Capable of writing production-ready
          ...
          >
            {github ? (
              <a href="https://github.com/devchetan123" target="_blank"  rel="noreferrer" >
                <img
        ...
        <div>
          <img
            ...
            src="https://i.ibb.co/G3DD8t5/Whats-App-Image-2022-03-16-at-4-58-53-PM.jpg"
            alt="profile"
            height={"250px"}
          />
        </div>
      ...
      <div className={style.projectMainDiv} id="project" data-aos="fade-up" >
        ...
        <Card sx={{ maxWidth: 570 }} className={style.cardMain} data-aos="fade-up" >
            <CardMedia
              component="img"
              height="300"
              image="https://i.ibb.co/qNnfTvw/screencapture-healthkart-mu-vercel-app-2022-04-07-11-22-10.png"
              alt="green iguana"
            />
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                <p>
                HealthKart is a e-commerce shopping website where users can buy products related to health and fitness.
                </p>
                <p>
                A collaborative project built by a team of 4, executed in 7 days.
                </p>
                ...
                <p>
                  <img
                    ...
                    height={"12px"}
                  />{" "}
                  Add cart to place a order pages and wishlist along with functionalities.
                </p>
                ...
                <p className={style.techStack}>
                  <b>Tech Stack</b> : React | Redux | NodeJS | Express | MongoDB |
                  Material UI
                </p>
              </Typography>
            </CardContent>
            <CardActions className={style.gobtns}>
              <a className={style.anchorLink}  href="https://github.com/devchetan123/healthkart-clone" target="_blank"  rel="noreferrer" >
              <Button
              ...
              <a className={style.anchorLink}  href="https://healthkart-mu.vercel.app/" target="_blank"  rel="noreferrer" >
              <Button
                size="small"
              >
                <img
          ...
          <Card sx={{ maxWidth: 570 }} className={style.cardMain} data-aos="fade-up" >
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                <p>
                  <img
                    ...
                    height={"12px"}
                  />{" "}
                  Log in, Signup, Forget password, Profile & Chat pages.
                </p>
                <p className={style.paraofrole}>
                  <img
                    src="https://i.ibb.co/hDczqkk/icons8-arrow-48.png"
            ...
            <CardActions className={style.gobtns}>
              <a className={style.anchorLink}  href="https://github.com/devchetan123/Instagram_clone" target="_blank"  rel="noreferrer" >
              <Button
                className={style.gitlaunchbtn}
                size="small"
              >
              ...
              <a className={style.anchorLink}  href="https://instacloneweb.netlify.app/" target="_blank"  rel="noreferrer" >
              <Button
                size="small"
              >
                <img
          ...
          <Card sx={{ maxWidth: 570 }} className={style.cardMain} data-aos="fade-up" >
            ...
            <CardActions className={style.gobtns}>
            <a className={style.anchorLink} href="https://github.com/devchetan123/tour-project" target="_blank"  rel="noreferrer" >
              <Button
                size="small"
              >
                <img
              ...
              <a className={style.anchorLink}  href="https://devchetan123.github.io/tour/" target="_blank"  rel="noreferrer" >
              <Button
                size="small"
              >
                <img
